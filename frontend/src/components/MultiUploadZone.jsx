...
import { UploadCloudIcon, ImageIcon, ZapIcon } from "./Icons";
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 mb-1 border border-slate-200">
            <UploadCloudIcon className="w-6 h-6 text-slate-600" />
          </div>
          ...
          <button
            type="button"
            className="mt-2 inline-flex items-center px-4 py-1.5 text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-300 rounded shadow-sm transition-colors"
            onClick={(e) => {
              e.stopPropagation();
        ...
        <div className="bg-white border border-slate-300 rounded-lg p-5 shadow-sm flex flex-col gap-4">
          ...
          <div className="bg-slate-50 border border-slate-300 rounded-lg p-4 flex flex-wrap justify-between items-center gap-4">
            ...
            <div>
              <button
                type="button"
                className="w-full sm:w-auto px-6 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold tracking-wider uppercase rounded shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
