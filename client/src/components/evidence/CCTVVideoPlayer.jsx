...
export default function CCTVVideoPlayer({
  ...
  return (
    <div
      ...
      className="relative rounded-2xl overflow-hidden bg-black border border-slate-800 shadow-2xl group select-none aspect-video flex items-center justify-center"
    >
      {/* ─── Video Element ────────────────────────────────────────── */}
      {blobUrl && (
        <video
      ...
      {/* ─── Loading Overlay ──────────────────────────────────────── */}
      {isLoading && (
        <div className="absolute inset-0 bg-black/80 backdrop-blur-xs flex flex-col items-center justify-center gap-3 z-30">
      ...
      >
        <div className="flex items-center gap-2.5 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10">
          ...
          <div className="text-[11px] font-mono text-emerald-400 font-bold">
            <span>{cameraId}</span> · <span className="text-slate-300">{locationName}</span>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 bg-emerald-950/80 backdrop-blur-md px-3 py-1.5 rounded-xl border border-emerald-500/40 text-emerald-400 text-[10px] font-mono font-bold shadow-xs">
            <Lock className="w-3 h-3" />
            <span>AES-256-GCM · SHA-256 SEALED</span>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 text-white text-xs">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Timestamps */}
            <div className="font-mono text-[11px] text-slate-300 pl-2">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="px-2 py-1 rounded-md bg-white/10 hover:bg-white/20 text-[11px] font-mono font-bold text-slate-200 transition-all cursor-pointer"
